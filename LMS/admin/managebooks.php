...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <td><button type="submit"><a href="editbooks.php?bn=<?php echo $row['book_num'];?>" class="editbooks-btn">Edit</button>
            <button class="editbtn"><a href="deletebooks.php?bn=<?php echo $row['book_num'];?>" class="editbooks-btn">Delete</button></td>
        </tr>
        <?php
             }
            ?>
